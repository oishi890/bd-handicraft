...
const Products = () => {
  ...
  if (isError)
    return (
      <section className="w-full h-[500px] flex flex-col justify-center items-center mx-auto">
        ...
        <h2 className="mt-2 text-lg font-medium text-center dark:text-white text-gray-800">
          No Data Found
        </h2>
      </section>
    );
  ...
  return (
    <div className="min-h-screen py-20 max-w-7xl mx-auto">
      <Helmet>
        <title>Bangladeshi Handcrafts | Products</title>
      </Helmet>
      ...
      <div className="max-w-5xl lg:max-w-4xl xl:max-w-7xl grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 p-5 mx-auto justify-center gap-5 xl:gap-10">
